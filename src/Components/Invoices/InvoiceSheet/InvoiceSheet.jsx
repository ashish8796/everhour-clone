        ...
        <div>
          <Head>
            ...
            {status === "DRAFT" ? (
              ...
              <button style={{ backgroundColor: "#EAEAEA", color: "#767676" }}>
                {status}
              </button>
            )}
          </Head>
          <div>
            <Top>
              <button className={status} onClick={() => saveInvoice()}>
                Mark as Sent
              </button>
            ...
            <Mid>
              <div>
                <div>
                  <h3>
                    <span>Billed To :</span> {clientDetails.name}
                  </h3>
                  <p></p>
                </div>
