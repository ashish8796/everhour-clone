        ...
        <div className={styles.sylingFormBox}>
          ...
          <div>
            <div className={styles.ExpensesFlexDiv}>
              <label className={styles.ExpensesFormFirstLabel} htmlFor="">
                Choose Project
              </label>
              {/* <input className={styles.ExpensesFormInput} type="text" name="projectName" onChange={(e)=>handleChange(e)} /> */}
              <Select name="projectName" onChange={(e) => handleChange(e)}>
            ...
            <br />
            <label className={styles.ExpensesFormSecondLabel} htmlFor="">
              Category
            </label>
            <div className={styles.ExpensesFlexDiv}>
              <input
                ...
                className={styles.ExpensesFormInput}
                type="text"
