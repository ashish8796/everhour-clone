          ...
          <div>
            ...
            <Seconddiv>
              <div>
                ...
                <p>
                  Evaluate the time spent and see the amount of planned time in
                  the future. <Link to="">Learn more</Link>
                </p>

                <h4>Time off Request for Members</h4>
                <p>
                  Everhour team members can now request time off, which team
                  admins can then approve.<Link to="">Learn more</Link>
                </p>

                <h4>Scheduled Tasks Now Sync into Timesheet</h4>
                <p>
                  The tasks of the assignments that you create on the Schedule
                  page are now automatically synced to the Timeshee...{" "}
